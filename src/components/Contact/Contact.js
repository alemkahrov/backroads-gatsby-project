  ...
  return (
    <section className={styles.contact}>
      ...
      <div className={styles.center}>
        <form className={styles.form} method="POST" netlify-honeypot="hpfield" netlify>
          <div>
            <input type="text" name="name" id="name" className={styles.formControl} placeholder="john smith" />
          </div>

          <div>
            <input type="email" name="email" id="email" className={styles.formControl} placeholder="email@gmail.com" />
          </div>
